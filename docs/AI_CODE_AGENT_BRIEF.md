...
> 本页用于约束 AI Code Agent 的第一轮实现。开始写代码前，必须先阅读 `AGENTS.md`、`项目规划/planV1.md`、`MOBILE_STYLE.md`，并以本页作为本次任务边界。
...
- 只有 `pep-g8-down-ch16` 下的 16.1 / 16.2 / 16.3 可进入练习。
- 未上线章节置灰，显示「即将上线」，不可进入练习。
